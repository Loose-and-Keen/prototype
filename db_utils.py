...
# --- ここから追加！ ---
        ...
        knowledge_data_money = (
            'money', 
            '投資って何から始めればいい？', 
            '楽天経済圏 + S&P500インデックス投資が最強の「型」', 
            'NISA/DCの税制優遇をフル活用し、手数料最安のS&P500で世界経済の成長に乗るのが、感情を排除した最短ルートだから。', 
            '俺も昔は個別株で一喜一憂してたけど、結局インデックス投資の「何もしない」が一番強いって気づいたんだよな。', 
            """
            ...
            **フェーズ3: 忘れる！**
            1. あとはマネーフォワードでたまに眺めるだけ。これが最強の「Loose & Keen」投資だぜ！
            """
        )
        ...
        knowledge_data_career = (
            ...
            '「基本書1冊」と「WBS」だけ意識しろ',
            'PMの仕事は「管理」じゃなくて、「ブラックボックスを可視化（WBS化）」して「完遂」することだから。',
            '俺も最初はSEで、顧客の「こういうことっすか？」を言語化し続けてたら、自然とPMになってたんだよな。',
            """
            **ステップ1: 知識のインストール**
            1. 『プロジェクトマネジメントの基本がぜんぶわかる本』みたいな薄い基本書を1冊だけ買って読め！
            
            **ステップ2: 実践（WBS化）**
            1. 今やってる仕事（なんでもいい）を「WBS（やることリスト）」に分解する癖をつけろ。
            2. 「誰が」「いつまでに」「何を」やるのかを明確にするんだ。
            
            **ステップ3: 報告**
            1. そのWBSを上司に見せて、「俺はこうやって進めようと思うんすけど、どうすか？」って「納得」を取り付けろ。
        ...
        knowledge_data_love = (
            ...
            '俺も昔はメッセージのやり取りで消耗してたわ…あれマジで時間の無駄だった（笑）',
            """
            **最短ルートWBS:**
            1. バチェラーデートに登録。
            ...
            **【高得点の「型」（プレミアムプラン用だぜ笑）】**
            * **会話:** 相手の話を「Loose & Keen」で深掘りしろ。
            * **会計:** 絶対に奢れ。それが「信頼」への最短投資だ。
            * **連絡先:** デート後に必ずLINE交換の打診をする。
            
            これでOK。めんどくさいことはAIに任せようぜ！
            """
        )
        ...
        knowledge_data_beauty = (
            ...
            '化粧水とか乳液とか色々やるのは「めんどくさい」だろ？ 大事なのは「保湿」と「強力な成分」。だから安いパック＋ニベア（保湿）と、金かける美容液（成分）だけでOK。',
            '俺も色々試したけど、結局この形に落ち着いたわ。髭脱毛（ヤグレーザー8回で十分！）はマジで人生変わるぜ。朝の時間が5分増えるからな！',
            """
            **ステップ1: 日常ケア（習慣化）**
            1. 毎晩、安い大容量パック（ドンキとかの）する。
            2. 終わったら、金かけた「いい美容液」（オバジC25とか）を塗る。
            3. 最後にニベアの青缶でフタをする。以上！
            
            **ステップ2: 根本解決（髭脱毛）**
            1. ヤグレーザー（YAG）一択。医療脱毛で「ヤグで」って指定しろ。
            2. 8回もやればマジでツルツルだぜ。
            """
        )
        ...
        knowledge_data_fashion = (
            'fashion',
            '服選ぶのめんどくさい…',
            '「仕事着の固定化」と「私服のトレンド把握」を分離しろ',
            '毎日服選ぶ時間こそ人生の無駄だろ？仕事着は「ノンアイロンジャージシャツ（白）」で固定。これで意思決定コストがゼロになる。',
            '俺も昔は色々悩んでたけど、これにしてからマジで楽になったわ。',
            """
            **WBS: 仕事着の最短ルート**
            1. ユニクロか無印で「ノンアイロンジャージシャツ（白）」を5枚買え。
            2. ズボンは黒のスラックス。以上。
            
            **WBS: 私服の最短ルート**
            1. GUか街中で「今っぽいな」ってトレンドを把握する。
            2. 「Shein（シーイン）」のアプリで、人気ランキング上位の安いやつを買う。
            3. これでOK。失敗しても安いから痛くないぜ！
            """
        )
